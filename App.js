...
import Carousel4 from './component/Carousel4';
import {ENTRIES1,ENTRIES2} from './static/entries' 
...
export default class App extends Component {
  ...
  render() {
    return (
      <ScrollView style={{flex:1,backgroundColor:'white',paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight : 0}} >

        {/* <SnapCarousel data1={this.state.data1} data2={this.state.data2}/> */}
        <Text>Example 1</Text>
        <Carousel data1={this.state.data1} data2={this.state.data2}/>
        <Text>Example 2</Text>
        <Carousel2 data1={this.state.data1} data2={this.state.data2}/>
        <Text>Example 3</Text>
        <Carousel3 data1={this.state.data1} data2={this.state.data2}/>
        <Text>Example 4</Text>
        <Carousel4 data1={this.state.data1} data2={this.state.data2}/>
